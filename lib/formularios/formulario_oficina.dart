...
class AgregarOficina extends StatefulWidget{
  @override
  _AgregarOficinaState createState() => _AgregarOficinaState();
}

class _AgregarOficinaState extends State<AgregarOficina> {
