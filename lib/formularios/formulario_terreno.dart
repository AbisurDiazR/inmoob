...
class _AgregarTerrenoState extends State<AgregarTerreno> {
  ...
  //Variables para el dropdown del tipo de moneda
  ...
  //flujo de datos del modelo inmuebles
  ...
  _agregarInmueble() async {
    ...
    int superficieTotal = int.tryParse(_superficieTotalController.text);
