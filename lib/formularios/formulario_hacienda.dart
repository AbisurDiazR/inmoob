...
class AgregarHacienda extends StatefulWidget{

  @override
  _AgregarHaciendaState createState() => _AgregarHaciendaState();
}

class _AgregarHaciendaState extends State<AgregarHacienda> {
